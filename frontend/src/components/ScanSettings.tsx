...
export default function ScanSettings() {
  ...
  return (
    <div className="w-full max-w-[1120px] mx-auto animate-fade-in">
      {/* Hero */}
      <div className="pt-3 space-y-2 mb-10 sm:mb-12">
      ...
      {/* Run button */}
      <div className="sticky bottom-6 z-10 flex justify-center w-full pt-4 mt-2">
        <Button
          variant="primary"
          size="lg"
          loading={scanning}
          onClick={runScan}
          className="w-full max-w-[760px] justify-center shadow-lg hover:shadow-xl"
        >
...
function StepCard({
  ...
  return (
    <Card className={`animate-fade-in stagger-${step} p-8 sm:p-9 shadow-[var(--shadow)]`}>
